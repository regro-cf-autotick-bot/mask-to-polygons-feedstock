...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mask-to-polygons-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13343&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mask-to-polygons-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mask-to-polygons` can be installed with:

```
conda install mask-to-polygons
```

It is possible to list all of the versions of `mask-to-polygons` available on your platform with:
